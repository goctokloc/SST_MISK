...
%robot jedzie i nie wykryto żadnej przeszkody
if sum(detStateV) == 0
    v_des=0.15;
end
...
angle=2*(angle_sum/d_sum)+sign(randi([-1,1],1))*20; %TODO: sprawdzić mnożnik 
v_des=0.04;                                                  % zastanowić się jak zmieniać kierunek jadąc wprost na ścianę             
